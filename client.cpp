...
class AppData
{
	...
	void CheckExit(string str)
	{
        ...
        void PrintIfReceivedFully()
        {
        	...
        	//Arbitrarily added -1 indicating the end of a sentence
        	//when facing a -1, we can print it as it is a full sentence
...
void StartUp()
{
	...
	//creating the socket to use and bind
...
int main(int argc, char** argv) {
	...
	//Ipv4 address of server (For example : 127.0.0.1)
    	SERVERIP = argv[1];
